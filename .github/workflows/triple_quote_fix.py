...
# Fix the broken msg strings with triple quotes for safety
...
# Use triple quotes in the SEARCH pattern too
...
print("SUCCESS: Full reg_finish triple-quote fix completed.")
